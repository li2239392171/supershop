...
<meta charset="utf-8">
<title>-.-</title>
<link rel="stylesheet" href="/SpSp/Public/admin/css/index.css">
</head>
...
<body>
    ...
    <div class="operation_user clearfix">
       <!--   <div class="link fl"><a href="#">慕课</a><span>&gt;&gt;</span><a href="#">商品管理</a><span>&gt;&gt;</span>商品修改</div>-->
        <div class="link fr">
            <b>欢迎您
            <?php  if(isset($_SESSION['adminName'])){ echo $_SESSION['adminName']; }elseif(isset($_COOKIE['adminName'])){ echo $_COOKIE['adminName']; } ?>
            
            </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="icon icon_i">首页</a><span></span><a href="#" class="icon icon_j">前进</a><span></span><a href="#" class="icon icon_t">后退</a><span></span><a href="#" class="icon icon_n">刷新</a><span></span><a href="<?php echo U('Login/logout');?>" class="icon icon_e">退出</a>
        </div>
    </div>
                ...
                <ul class="mList">
                    ...
                    <li>
                        ...
                        <dl id="menu2" style="display:none;">
                        	<dd><a href="<?php echo U('Category/addCate');?>" target="mainFrame">添加分类</a></dd>
                            <dd><a href="<?php echo U('Category/listCate');?>" target="mainFrame">分类列表</a></dd>
                        </dl>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <dl id="menu4" style="display:none;">
                        	<dd><a href="<?php echo U('User/addUser');?>" target="mainFrame">添加用户</a></dd>
                    ...
                    <li>
                        ...
                        <dl id="menu5" style="display:none;">
                            <dd><a href="<?php echo U('listAdmin');?>" target="mainFrame">管理员列表</a></dd>
                            <dd><a href="<?php echo U('addAdmin');?>" target="mainFrame">添加管理员</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
